...
const EditSiteModal: NextPage = () => {
    const [, toggleModal] = useModal();

    return (
        <div className="w-full p-7 flex flex-col ">
            <h5 className="text-xl font-semibold text-gray-800 mb-8 mt-3">Edit Site</h5>

            <div className="flex flex-col space-y-4">
                <div className="flex flex-col">
                    <label className="mb-1 text-sm font-semibold" htmlFor="SiteName">Site Name</label>
                    <input
                        type="text"
                        placeholder="Your site name"
                        className="border-2 border-zinc-300 w-full py-1 px-3 placeholder:text-sm placeholder:text-zinc-300 rounded"
                    />
                </div>
                <div className="flex flex-col">
                    <label className="mb-1 text-sm font-semibold" htmlFor="SiteName">Description</label>
                    <input
                        type="text"
                ...
                <div className="flex flex-col">
                    <label className="mb-1 text-sm font-semibold" htmlFor="SiteName">Upload your site logo</label>
                    ...
                    <div className="relative block w-full py-2 px-3 bg-gray-100 rounded appearance-none border-0">
                        ...
                        <div className="flex items-center justify-between space-x-3">
                            <div className="flex items-center space-x-4">
                                ...
                                <span className="text-gray-500 text-sm">Required_File.png</span>
                            </div>
                            <span className="flex items-center py-1 px-3 text-green-600 text-sm text-center font-medium border border-transparent rounded outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-40">
